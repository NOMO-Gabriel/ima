...
echo "<h1>Test de Requête et Réponse Laravel</h1>";
...
'/home/u777715388/domains/darkgoldenrod-deer-926463.hostingersite.com/ima/bootstrap/app.php';
        ...
        try {
            ...
            try {
                ...
                echo "<p style='color:green;font-weight:bold;'>✓ Requête capturée avec succès!</p>";
                
                try {
                    $response = $kernel->handle($request);
                    echo "<p style='color:green;font-weight:bold;'>✓ Réponse générée avec succès!</p>";
                } catch (Throwable $e) {
                    die("<p style='color:red;font-weight:bold;'>✗ Erreur lors de la génération de la réponse: " . 
$e->getMessage() . "</p><pre>" . $e->getTraceAsString() . "</pre>");
                }
            } catch (Throwable $e) {
                die("<p style='color:red;font-weight:bold;'>✗ Erreur lors de la capture de la requête: " . 
$e->getMessage() . "</p><pre>" . $e->getTraceAsString() . "</pre>");
            }
        } catch (Throwable $e) {
