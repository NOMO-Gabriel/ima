...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('password.email', ['locale' => app()->getLocale()])); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/gabriel/Documents/projects/bussiness/ima-icorp/code-ima-icorp/prod/ima/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>