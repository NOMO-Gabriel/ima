<section>
    ...
    <form method="post" action="<?php echo e(route('password.update', ['locale' => app()->getLocale()])); ?>" class="mt-6 space-y-6">
        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/gabriel/Documents/projects/bussiness/ima-icorp/code-ima-icorp/prod/ima/resources/views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>