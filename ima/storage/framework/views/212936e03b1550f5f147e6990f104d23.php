...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'IMA-ICORP')); ?></title>
    ...
    <body class="font-sans antialiased text-gray-900">
        <div class="min-h-screen flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 text-center text-sm text-gray-600">
                <p>&copy; <?php echo e(date('Y')); ?> Intelligentsia Corporation. Tous droits réservés.</p>
...
</html><?php /**PATH /home/gabriel/Documents/projects/bussiness/ima-icorp/code-ima-icorp/prod/ima/resources/views/layouts/guest.blade.php ENDPATH**/ ?>