...
<head>
    ...
    <title><?php echo e(config('app.name', 'ICORP')); ?> - Institut de Formation</title>
...
<!-- Styles -->
<?php if(app()->environment('local') && !app()->runningUnitTests()): ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
<?php else: ?>
    <link rel="stylesheet" href="<?php echo e(vite_asset('css/app.css')); ?>">
    <script src="<?php echo e(vite_asset('js/app.js')); ?>" defer></script>
<?php endif; ?>
</head>
<body
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <div class="flex items-center">
                <img src="<?php echo e(asset('logo-icorp-white.png')); ?>" alt="ICORP Logo" class="h-10 mr-3"
            ...
            <div class="hidden lg:flex lg:space-x-8 items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 py-2 w-32 rounded-md shadow-lg transition-colors duration-300"
                        ...
                        <a href="<?php echo e(route('welcome', ['locale' => 'fr'])); ?>" class="block px-4 py-2 text-sm transition-colors duration-300 flex items-center justify-between"
                           :class="{
             'text-gray-300 hover:bg-slate-600': darkMode,
             'text-gray-700 hover:bg-gray-100': !darkMode,
             'font-bold': '<?php echo e(app()->getLocale()); ?>' === 'fr'
           }">
                            Français
                        ...
                        <a href="<?php echo e(route('welcome', ['locale' => 'en'])); ?>" class="block px-4 py-2 text-sm transition-colors duration-300 flex items-center justify-between"
                           :class="{
             'text-gray-300 hover:bg-slate-600': darkMode,
             'text-gray-700 hover:bg-gray-100': !darkMode,
             'font-bold': '<?php echo e(app()->getLocale()); ?>' === 'en'
           }">
                            English
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard', ['locale' => app()->getLocale()])); ?>" class="bg-sky-600 text-white hover:bg-sky-700 transition-colors duration-300 px-4 py-2 rounded-md text-sm font-medium">Tableau de bord</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login', ['locale' => app()->getLocale()])); ?>" class="transition-colors duration-300 px-3 py-2 text-sm font-medium"
                       :class="{ 'text-gray-300 hover:text-white': darkMode, 'text-gray-600 hover:text-sky-600': !darkMode }">Connexion</a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register', ['locale' => app()->getLocale()])); ?>" class="bg-sky-600 text-white hover:bg-sky-700 transition-colors duration-300 px-4 py-2 rounded-md text-sm font-medium">Inscription</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute top-16 right-0 left-0 transition-colors duration-300 shadow-md"
                        ...
                        <div class="px-4 py-3 space-y-3">
                            ...
                            <div class="border-t pt-3 mt-3" :class="{ 'border-gray-700': darkMode, 'border-gray-200': !darkMode }">
                                <p class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider"><?php echo e(__('Langue')); ?></p>
                                <div class="mt-2 flex space-x-2 px-3">
                                    <a href="<?php echo e(route('welcome', ['locale' => 'fr'])); ?>" class="transition-colors duration-300 px-3 py-1 text-sm font-medium rounded-md flex items-center"
                                       :class="{
             'bg-slate-700 text-white': darkMode,
             'bg-gray-100 text-gray-800': !darkMode,
             'ring-2 ring-sky-500': '<?php echo e(app()->getLocale()); ?>' === 'fr'
           }">
                                        FR
                                        <?php if(app()->getLocale() === 'fr'): ?>
                                    ...
                                    <a href="<?php echo e(route('welcome', ['locale' => 'en'])); ?>" class="transition-colors duration-300 px-3 py-1 text-sm font-medium rounded-md flex items-center"
                                       :class="{
             'bg-slate-700 text-white': darkMode,
             'bg-gray-100 text-gray-800': !darkMode,
             'ring-2 ring-sky-500': '<?php echo e(app()->getLocale()); ?>' === 'en'
           }">
                                        EN
                                        <?php if(app()->getLocale() === 'en'): ?>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1 text-sky-400" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div class="border-t pt-3 mt-3" :class="{ 'border-gray-700': darkMode, 'border-gray-200': !darkMode }">
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(url('/dashboard')); ?>" class="block w-full text-center bg-sky-600 text-white hover:bg-sky-700 transition-colors duration-300 px-4 py-2 rounded-md text-base font-medium">
                                        Tableau de bord
                                    </a>
                                <?php else: ?>
                                    <div class="flex flex-col space-y-2">
                                        <a href="<?php echo e(route('login', ['locale' => app()->getLocale()])); ?>" class="block transition-colors duration-300 px-3 py-2 text-base font-medium rounded-md text-center"
                                           :class="{ 'text-gray-300 hover:bg-slate-700 hover:text-white': darkMode, 'text-gray-600 hover:bg-gray-100 hover:text-sky-600': !darkMode }">
                                            Connexion
                                        </a>
                                        <?php if(Route::has('register')): ?>
                                            <a href="<?php echo e(route('register', ['locale' => app()->getLocale()])); ?>" class="block w-full text-center bg-sky-600 text-white hover:bg-sky-700 transition-colors duration-300 px-4 py-2 rounded-md text-base font-medium">
                                                Inscription
                                            </a>
                                        <?php endif; ?>
                                    </div>
...
<section class="pt-32 pb-20 lg:pt-40 lg:pb-28 relative transition-colors duration-300"
    ...
    <div class="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none">
        <img src="<?php echo e(asset('logo-icorp.png')); ?>" alt="ICORP Logo Background" class="w-3/4 max-w-2xl blur-sm"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div class="backdrop-blur-sm rounded-xl shadow-lg p-8 md:p-12 max-w-4xl mx-auto transition-colors duration-300"
            ...
            <h1 class="text-3xl md:text-5xl font-bold mb-4 font-montserrat transition-colors duration-300"
                ...
                <?php echo e(__('Préparez votre avenir')); ?> <span class="text-sky-600"><?php echo e(__('avec ICORP')); ?></span>
            </h1>
            <p class="text-lg lg:text-xl mb-8 max-w-3xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Centre de préparation aux concours nationaux et internationaux au Cameroun. Réussissez vos examens et obtenez des bourses d\'études grâce à nos formations intensives et personnalisées.')); ?>
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <a href="#formations" class="inline-flex items-center justify-center px-6 py-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-colors duration-300">
                    <i class="fas fa-graduation-cap mr-2"></i> <?php echo e(__('Découvrir nos formations')); ?>
                ...
                <a href="#contact" class="inline-flex items-center justify-center px-6 py-4 border rounded-md shadow-sm text-base font-medium transition-colors duration-300"
                   :class="{ 'border-gray-600 text-white hover:bg-slate-700': darkMode, 'border-gray-300 text-sky-600 bg-white hover:bg-gray-50': !darkMode }">
                    <i class="fas fa-envelope mr-2"></i> <?php echo e(__('Nous contacter')); ?>
            ...
            <div class="mt-12 flex flex-wrap justify-center gap-8">
                <div class="flex items-center">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-sm transition-colors duration-300"
                             :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }"><?php echo e(__('Élèves formés')); ?></div>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-sm transition-colors duration-300"
                             :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }"><?php echo e(__('Taux de réussite')); ?></div>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="text-left">
                        ...
                        <div class="text-sm transition-colors duration-300"
                             :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }"><?php echo e(__('Centres au Cameroun')); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-2xl md:text-3xl font-bold font-montserrat transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Nos Programmes de Formation')); ?></h2>
            ...
            <p class="mt-3 text-base md:text-lg max-w-2xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Programmes adaptés pour vous préparer aux concours nationaux et internationaux')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="rounded-md shadow-sm hover:shadow-md transition duration-300 overflow-hidden"
                ...
                <div class="relative h-40 overflow-hidden">
                    <img src="<?php echo e(asset('images/concours-administratifs.jpg')); ?>" alt="Concours Administratifs"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-3">
                        <h3 class="text-lg font-bold text-white"><?php echo e(__('Concours Administratifs')); ?></h3>
                        <span class="inline-block mt-1 px-2 py-0.5 bg-sky-600 text-white text-xs rounded-sm">
                            <?php echo e(__('Concours Nationaux')); ?>
                ...
                <div class="p-4">
                    <p class="text-sm transition-colors duration-300 mb-3 line-clamp-2"
                       :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <?php echo e(__('Préparation: ENAM, IRIC, ISSEA, Police, Gendarmerie')); ?>
            ...
            <div class="rounded-md shadow-sm hover:shadow-md transition duration-300 overflow-hidden"
                 :class="{ 'bg-slate-800': darkMode, 'bg-white': !darkMode }">
                <div class="relative h-40 overflow-hidden">
                    <img src="<?php echo e(asset('images/grandes-ecoles.jpg')); ?>" alt="Grandes Écoles"
                         class="w-full h-full object-cover"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 right-0 p-3">
                        <h3 class="text-lg font-bold text-white"><?php echo e(__('Grandes Écoles')); ?></h3>
                        <span class="inline-block mt-1 px-2 py-0.5 bg-sky-600 text-white text-xs rounded-sm">
                            <?php echo e(__('Écoles d\'Ingénieurs et Commerce')); ?>
                ...
                <div class="p-4">
                    <p class="text-sm transition-colors duration-300 mb-3 line-clamp-2"
                       :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <?php echo e(__('Préparation: Polytechnique, ENSTP, ESSEC, UCAC, ENSP')); ?>
            ...
            <div class="rounded-md shadow-sm hover:shadow-md transition duration-300 overflow-hidden"
                 :class="{ 'bg-slate-800': darkMode, 'bg-white': !darkMode }">
                <div class="relative h-40 overflow-hidden">
                    <img src="<?php echo e(asset('images/bourses-internationales.jpg')); ?>" alt="Bourses Internationales"
                         class="w-full h-full object-cover"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 right-0 p-3">
                        <h3 class="text-lg font-bold text-white"><?php echo e(__('Bourses Internationales')); ?></h3>
                        <span class="inline-block mt-1 px-2 py-0.5 bg-sky-600 text-white text-xs rounded-sm">
                            <?php echo e(__('Études à l\'étranger')); ?>
                ...
                <div class="p-4">
                    <p class="text-sm transition-colors duration-300 mb-3 line-clamp-2"
                       :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <?php echo e(__('Dossiers: DAAD, Fulbright, Chevening, Campus France')); ?>
            ...
            <div class="rounded-md shadow-sm hover:shadow-md transition duration-300 overflow-hidden"
                 :class="{ 'bg-slate-800': darkMode, 'bg-white': !darkMode }">
                <div class="relative h-40 overflow-hidden">
                    <img src="<?php echo e(asset('images/examens-officiels.jpg')); ?>" alt="Examens Officiels"
                         class="w-full h-full object-cover"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 right-0 p-3">
                        <h3 class="text-lg font-bold text-white"><?php echo e(__('Examens Officiels')); ?></h3>
                        <span class="inline-block mt-1 px-2 py-0.5 bg-sky-600 text-white text-xs rounded-sm">
                            <?php echo e(__('Diplômes Nationaux')); ?>
                ...
                <div class="p-4">
                    <p class="text-sm transition-colors duration-300 mb-3 line-clamp-2"
                       :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <?php echo e(__('Préparation: BEPC, Probatoire, Baccalauréat, BTS')); ?>
            ...
            <div class="rounded-md shadow-sm hover:shadow-md transition duration-300 overflow-hidden"
                 :class="{ 'bg-slate-800': darkMode, 'bg-white': !darkMode }">
                <div class="relative h-40 overflow-hidden">
                    <img src="<?php echo e(asset('images/tests-internationaux.jpg')); ?>" alt="Tests Internationaux"
                         class="w-full h-full object-cover"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 right-0 p-3">
                        <h3 class="text-lg font-bold text-white"><?php echo e(__('Tests Internationaux')); ?></h3>
                        <span class="inline-block mt-1 px-2 py-0.5 bg-sky-600 text-white text-xs rounded-sm">
                            <?php echo e(__('Certifications Internationales')); ?>
                ...
                <div class="p-4">
                    <p class="text-sm transition-colors duration-300 mb-3 line-clamp-2"
                       :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <?php echo e(__('Préparation: TOEFL, IELTS, SAT, GRE, GMAT, TCF, TEF')); ?>
            ...
            <div class="rounded-md shadow-sm hover:shadow-md transition duration-300 overflow-hidden"
                 :class="{ 'bg-slate-800': darkMode, 'bg-white': !darkMode }">
                <div class="relative h-40 overflow-hidden">
                    <img src="<?php echo e(asset('images/formations-speciales.jpg')); ?>" alt="Formations Spéciales"
                         class="w-full h-full object-cover"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 right-0 p-3">
                        <h3 class="text-lg font-bold text-white"><?php echo e(__('Formations Spéciales')); ?></h3>
                        <span class="inline-block mt-1 px-2 py-0.5 bg-sky-600 text-white text-xs rounded-sm">
                            <?php echo e(__('Formations Personnalisées')); ?>
                ...
                <div class="p-4">
                    <p class="text-sm transition-colors duration-300 mb-3 line-clamp-2"
                       :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <?php echo e(__('Cours intensifs et coaching personnalisé')); ?>
        ...
        <div class="mt-10 text-center">
            <a href="#contact" class="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-colors duration-300">
                <?php echo e(__('Demander plus d\'informations')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold font-montserrat transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Notre Méthode d\'Enseignement')); ?></h2>
            <div class="w-16 h-1 bg-sky-600 mx-auto mt-4"></div>
            <p class="mt-4 text-xl max-w-3xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Une approche pédagogique efficace pour un taux de réussite élevé')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mb-3 transition-colors duration-300"
                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Cours Structurés')); ?></h3>
                <p class="transition-colors duration-300"
                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                    <?php echo e(__('Cours méthodiques avec des supports pédagogiques complets et adaptés à chaque programme.')); ?>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mb-3 transition-colors duration-300"
                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Petits Groupes')); ?></h3>
                <p class="transition-colors duration-300"
                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                    <?php echo e(__('Classes limitées à 15-20 élèves pour garantir une attention personnalisée et un meilleur suivi.')); ?>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mb-3 transition-colors duration-300"
                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Évaluations Régulières')); ?></h3>
                <p class="transition-colors duration-300"
                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                    <?php echo e(__('Tests hebdomadaires et examens blancs pour mesurer les progrès et identifier les points à améliorer.')); ?>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mb-3 transition-colors duration-300"
                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Enseignants Qualifiés')); ?></h3>
                <p class="transition-colors duration-300"
                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                    <?php echo e(__('Professeurs expérimentés, souvent membres des jurys d\'examens et spécialistes dans leurs domaines.')); ?>
        ...
        <div class="mt-16 bg-gradient-to-r from-sky-600 to-sky-800 rounded-xl shadow-lg overflow-hidden">
            <div class="p-8 md:p-12 lg:flex items-center">
                <div class="lg:w-3/5 lg:pr-8 mb-8 lg:mb-0">
                    <h3 class="text-2xl font-bold text-white mb-4"><?php echo e(__('Pourquoi choisir ICORP?')); ?></h3>
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            <span class="text-white mr-2"><i class="fas fa-check-circle"></i></span>
                            <span class="text-white"><?php echo e(__('Taux de réussite supérieur à 92% dans tous nos programmes')); ?></span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-white mr-2"><i class="fas fa-check-circle"></i></span>
                            <span class="text-white"><?php echo e(__('Plus de 15 ans d\'expérience dans la préparation aux concours')); ?></span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-white mr-2"><i class="fas fa-check-circle"></i></span>
                            <span class="text-white"><?php echo e(__('Suivi personnalisé et soutien académique continu')); ?></span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-white mr-2"><i class="fas fa-check-circle"></i></span>
                            <span class="text-white"><?php echo e(__('Réseau d\'anciens élèves actifs et entraide communautaire')); ?></span>
                        </li>
                        <li class="flex items-start">
                            <span class="text-white mr-2"><i class="fas fa-check-circle"></i></span>
                            <span class="text-white"><?php echo e(__('Environnement d\'apprentissage moderne et stimulant')); ?></span>
                        </li>
                    </ul>
                </div>
                <div class="lg:w-2/5 lg:border-l lg:border-white/30 lg:pl-8">
                    <div class="text-center">
                        <p class="text-xl text-white mb-6"><?php echo e(__('Inscrivez-vous dès maintenant pour bénéficier de notre offre spéciale')); ?></p>
                        <div class="bg-white rounded-lg p-4 text-center">
                            <p class="text-sky-800 font-semibold mb-2"><?php echo e(__('Réduction de 15%')); ?></p>
                            <p class="text-gray-600 text-sm mb-4"><?php echo e(__('Pour toute inscription avant le 30 du mois')); ?></p>
                            <a href="#contact" class="inline-block px-6 py-3 bg-sky-700 text-white rounded-md hover:bg-sky-800 transition-colors duration-300">
                                <?php echo e(__('J\'en profite maintenant')); ?>
...
<section id="centres" class="py-16 transition-colors duration-300"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-bold font-montserrat transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Nos Centres de Formation')); ?></h2>
            <div class="w-16 h-1 bg-sky-600 mx-auto mt-3"></div>
            <p class="mt-4 text-base md:text-lg max-w-2xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Présents dans les principales villes du Cameroun pour être plus proche de vous')); ?>
            ...
            <div class="lg:col-span-5 flex flex-col gap-4">
                ...
                <div class="rounded-lg overflow-hidden transition-colors duration-300 border"
                    ...
                    <div class="flex flex-col sm:flex-row">
                        <div class="sm:w-1/3 h-40 sm:h-auto relative overflow-hidden">
                            ...
                            <img src="<?php echo e(asset('images/yaounde-centre.jpg')); ?>" alt="Yaoundé Centre"
                                 class="w-full h-full object-cover"
                            ...
                            <div class="absolute top-0 left-0 py-1 px-3 m-2 bg-sky-600 text-white text-xs rounded-full font-medium z-20">
                                <?php echo e(__('Centre Principal')); ?>
                        ...
                        <div class="sm:w-2/3 p-4">
                            ...
                            <div class="mt-3 pt-2 border-t" :class="{ 'border-slate-700': darkMode, 'border-gray-100': !darkMode }">
                                <a href="#contact" class="text-sky-600 hover:text-sky-700 text-sm font-medium flex items-center transition-colors duration-300">
                                    <i class="fas fa-info-circle mr-1"></i> <?php echo e(__('Demander des informations')); ?>
                ...
                <div class="rounded-lg overflow-hidden transition-colors duration-300 border"
                    ...
                    <div class="flex flex-col sm:flex-row">
                        <div class="sm:w-1/3 h-40 sm:h-auto relative overflow-hidden">
                            <div class="absolute inset-0 bg-sky-600 bg-opacity-10 z-10"></div>
                            <img src="<?php echo e(asset('images/douala.jpg')); ?>" alt="Douala"
                                 class="w-full h-full object-cover"
                ...
                <div class="rounded-lg overflow-hidden transition-colors duration-300 border"
                    ...
                    <div class="flex flex-col sm:flex-row">
                        <div class="sm:w-1/3 h-40 sm:h-auto relative overflow-hidden">
                            <div class="absolute inset-0 bg-sky-600 bg-opacity-10 z-10"></div>
                            <img src="<?php echo e(asset('images/bafoussam.jpg')); ?>" alt="Bafoussam"
                                 class="w-full h-full object-cover"
        ...
        <div class="transition-colors duration-300 rounded-lg p-5 mb-10"
            ...
            <h3 class="text-lg font-bold mb-4 transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }">
                <i class="fas fa-globe-africa text-sky-600 mr-2"></i> <?php echo e(__('Autres centres au Cameroun')); ?>
        ...
        <div class="text-center">
            <a href="#contact" class="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-colors duration-300">
                <i class="fas fa-map-marked-alt mr-2"></i> <?php echo e(__('Trouver un centre près de chez vous')); ?>
...
<section id="temoignages" class="py-20 transition-colors duration-300"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold font-montserrat transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Témoignages d\'Étudiants')); ?></h2>
            <div class="w-16 h-1 bg-sky-600 mx-auto mt-4"></div>
            <p class="mt-4 text-xl max-w-3xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Ce que disent nos étudiants qui ont réussi leurs concours')); ?>
...
<section id="contact" class="py-20 transition-colors duration-300"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold font-montserrat transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Contactez-nous')); ?></h2>
            <div class="w-16 h-1 bg-sky-600 mx-auto mt-4"></div>
            <p class="mt-4 text-xl max-w-3xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Prenez contact avec nous pour plus d\'informations sur nos formations')); ?>
            ...
            <div class="rounded-lg shadow-md overflow-hidden transition-colors duration-300"
                ...
                <div class="p-8">
                    <h3 class="text-xl font-bold mb-6 transition-colors duration-300"
                        :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Envoyez-nous un message')); ?></h3>

                    <form action="<?php echo e(route('contact.store', ['locale' => app()->getLocale()])); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label for="name" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }"><?php echo e(__('Nom complet')); ?></label>
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }"><?php echo e(__('Email')); ?></label>
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }"><?php echo e(__('Téléphone')); ?></label>
                        ...
                        <div>
                            <label for="formation" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }"><?php echo e(__('Formation souhaitée')); ?></label>
                            <select name="formation" id="formation"
                                    class="w-full px-4 py-3 rounded-md border transition-colors duration-300"
                                    :class="{ 'bg-slate-700 border-slate-600 text-white focus:border-sky-500': darkMode, 'border-gray-300 focus:border-sky-500 focus:ring-sky-500': !darkMode }">
                                <option value="" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Sélectionner une formation')); ?></option>
                                <option value="concours_administratifs" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Concours Administratifs')); ?></option>
                                <option value="grandes_ecoles" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Grandes Écoles')); ?></option>
                                <option value="bourses_internationales" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Bourses Internationales')); ?></option>
                                <option value="examens_officiels" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Examens Officiels')); ?></option>
                                <option value="tests_internationaux" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Tests Internationaux')); ?></option>
                                <option value="formations_speciales" :class="{ 'bg-slate-700': darkMode, 'bg-white': !darkMode }"><?php echo e(__('Formations Spéciales')); ?></option>
                            </select>
                        </div>

                        <div>
                            <label for="message" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }"><?php echo e(__('Message')); ?></label>
            ...
            <div class="space-y-8">
                <div class="rounded-lg shadow-md p-6 transition-colors duration-300"
                    ...
                    <h3 class="text-xl font-bold mb-4 transition-colors duration-300"
                        :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Coordonnées')); ?></h3>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold transition-colors duration-300"
                                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Adresse principale')); ?></h4>
                                <p class="transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold transition-colors duration-300"
                                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Téléphone')); ?></h4>
                                <p class="transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                                    +237 222 222 222<br>
                                    +237 677 777 777
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold transition-colors duration-300"
                                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Email')); ?></h4>
                                <p class="transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold transition-colors duration-300"
                                    :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Heures d\'ouverture')); ?></h4>
                                <p class="transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                                    <?php echo e(__('Lundi - Vendredi')); ?>: 8h - 18h<br>
                                    <?php echo e(__('Samedi')); ?>: 9h - 16h<br>
                                    <?php echo e(__('Dimanche')); ?>: <?php echo e(__('Fermé')); ?>
                ...
                <div class="rounded-lg shadow-md p-6 transition-colors duration-300"
                     :class="{ 'bg-slate-800': darkMode, 'bg-white': !darkMode }">
                    <h3 class="text-xl font-bold mb-4 transition-colors duration-300"
                        :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Suivez-nous')); ?></h3>
...
<section class="py-20 transition-colors duration-300"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold font-montserrat transition-colors duration-300"
                :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }"><?php echo e(__('Questions Fréquentes')); ?></h2>
            <div class="w-16 h-1 bg-sky-600 mx-auto mt-4"></div>
            <p class="mt-4 text-xl max-w-3xl mx-auto transition-colors duration-300"
               :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                <?php echo e(__('Trouvez des réponses aux questions les plus courantes sur nos formations')); ?>
            ...
            <div x-data="{ activeTab: 0 }" class="space-y-4">
                ...
                <div class="rounded-lg shadow-md overflow-hidden transition-colors duration-300"
                    ...
                    <button @click="activeTab = activeTab === 0 ? null : 0" class="w-full px-6 py-4 text-left flex justify-between items-center transition-colors duration-300"
                            :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }">
                        <span class="font-medium"><?php echo e(__('Comment s\'inscrire à une formation à ICORP?')); ?></span>
                    ...
                    <div x-show="activeTab === 0" x-collapse class="px-6 pb-4 transition-colors duration-300"
                         :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <p><?php echo e(__('Pour vous inscrire à une formation, vous pouvez:')); ?></p>
                        <ul class="list-disc pl-5 mt-2 space-y-1">
                            <li><?php echo e(__('Visiter l\'un de nos centres et vous inscrire directement sur place')); ?></li>
                            <li><?php echo e(__('Remplir le formulaire de contact sur notre site web')); ?></li>
                            <li><?php echo e(__('Nous appeler aux numéros indiqués')); ?></li>
                            <li><?php echo e(__('Nous envoyer un email à info@icorp-education.cm')); ?></li>
                        </ul>
                        <p class="mt-2"><?php echo e(__('Après votre préinscription, un conseiller pédagogique vous contactera pour finaliser votre inscription et vous fournir toutes les informations nécessaires.')); ?></p>
                    </div>
                </div>
                ...
                <div class="rounded-lg shadow-md overflow-hidden transition-colors duration-300"
                    ...
                    <button @click="activeTab = activeTab === 1 ? null : 1" class="w-full px-6 py-4 text-left flex justify-between items-center transition-colors duration-300"
                            :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }">
                        <span class="font-medium"><?php echo e(__('Quels sont les modes de paiement acceptés?')); ?></span>
                    ...
                    <div x-show="activeTab === 1" x-collapse class="px-6 pb-4 transition-colors duration-300"
                         :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <p><?php echo e(__('Nous acceptons plusieurs modes de paiement pour faciliter votre inscription:')); ?></p>
                        <ul class="list-disc pl-5 mt-2 space-y-1">
                            <li><?php echo e(__('Paiement en espèces dans nos centres')); ?></li>
                            <li><?php echo e(__('Paiement par Mobile Money (Orange Money, MTN Mobile Money, etc.)')); ?></li>
                            <li><?php echo e(__('Virement bancaire')); ?></li>
                            <li><?php echo e(__('Paiement échelonné (selon les formations)')); ?></li>
                        </ul>
                        <p class="mt-2"><?php echo e(__('Des facilités de paiement peuvent être accordées en fonction de votre situation. N\'hésitez pas à nous contacter pour en discuter.')); ?></p>
                    </div>
                </div>
                ...
                <div class="rounded-lg shadow-md overflow-hidden transition-colors duration-300"
                    ...
                    <button @click="activeTab = activeTab === 2 ? null : 2" class="w-full px-6 py-4 text-left flex justify-between items-center transition-colors duration-300"
                            :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }">
                        <span class="font-medium"><?php echo e(__('Quels documents faut-il fournir pour s\'inscrire?')); ?></span>
                    ...
                    <div x-show="activeTab === 2" x-collapse class="px-6 pb-4 transition-colors duration-300"
                         :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <p><?php echo e(__('Les documents à fournir varient selon la formation choisie, mais généralement vous devez présenter:')); ?></p>
                        <ul class="list-disc pl-5 mt-2 space-y-1">
                            <li><?php echo e(__('Une copie de votre pièce d\'identité ou acte de naissance')); ?></li>
                            <li><?php echo e(__('Une copie de votre dernier diplôme obtenu')); ?></li>
                            <li><?php echo e(__('2 photos d\'identité récentes (format 4x4)')); ?></li>
                            <li><?php echo e(__('Un dossier d\'inscription dûment rempli (disponible dans nos centres ou téléchargeable sur notre site)')); ?></li>
                        </ul>
                        <p class="mt-2"><?php echo e(__('Des documents supplémentaires peuvent être demandés selon le type de formation ou de concours visé.')); ?></p>
                    </div>
                </div>
                ...
                <div class="rounded-lg shadow-md overflow-hidden transition-colors duration-300"
                    ...
                    <button @click="activeTab = activeTab === 3 ? null : 3" class="w-full px-6 py-4 text-left flex justify-between items-center transition-colors duration-300"
                            :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }">
                        <span class="font-medium"><?php echo e(__('Proposez-vous des formations à distance?')); ?></span>
                    ...
                    <div x-show="activeTab === 3" x-collapse class="px-6 pb-4 transition-colors duration-300"
                         :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <p><?php echo e(__('Oui, ICORP propose des formations à distance pour la plupart de ses programmes:')); ?></p>
                        <ul class="list-disc pl-5 mt-2 space-y-1">
                            <li><?php echo e(__('Cours en ligne via notre plateforme d\'apprentissage')); ?></li>
                            <li><?php echo e(__('Cours par visioconférence en direct avec nos formateurs')); ?></li>
                            <li><?php echo e(__('Supports de cours numériques et exercices interactifs')); ?></li>
                            <li><?php echo e(__('Suivi et tutorat personnalisés à distance')); ?></li>
                        </ul>
                        <p class="mt-2"><?php echo e(__('Nos formations à distance sont conçues pour être aussi complètes et efficaces que nos formations en présentiel, avec un accompagnement régulier et des évaluations fréquentes.')); ?></p>
                    </div>
                </div>
                ...
                <div class="rounded-lg shadow-md overflow-hidden transition-colors duration-300"
                    ...
                    <button @click="activeTab = activeTab === 4 ? null : 4" class="w-full px-6 py-4 text-left flex justify-between items-center transition-colors duration-300"
                            :class="{ 'text-white': darkMode, 'text-gray-900': !darkMode }">
                        <span class="font-medium"><?php echo e(__('Quelles sont les dates de début des formations?')); ?></span>
                    ...
                    <div x-show="activeTab === 4" x-collapse class="px-6 pb-4 transition-colors duration-300"
                         :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
                        <p><?php echo e(__('Les dates de début de nos formations sont flexibles et s\'adaptent au calendrier des concours et examens:')); ?></p>
                        <ul class="list-disc pl-5 mt-2 space-y-1">
                            <li><?php echo e(__('Pour les concours administratifs: généralement de septembre à janvier')); ?></li>
                            <li><?php echo e(__('Pour les grandes écoles: d\'octobre à mars')); ?></li>
                            <li><?php echo e(__('Pour les examens officiels: tout au long de l\'année académique')); ?></li>
                            <li><?php echo e(__('Pour les formations aux tests internationaux: sessions mensuelles')); ?></li>
                        </ul>
                        <p class="mt-2"><?php echo e(__('Nous organisons également des sessions de formation intensives pendant les vacances scolaires. Contactez-nous pour connaître les dates précises des prochaines sessions de la formation qui vous intéresse.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-sky-600 to-sky-800 rounded-xl shadow-lg overflow-hidden">
            <div class="p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
                <div class="mb-8 md:mb-0 md:pr-8 max-w-3xl">
                    <h2 class="text-2xl md:text-3xl font-bold text-white mb-4"><?php echo e(__('Prêt à réussir vos concours et examens?')); ?></h2>
                    <p class="text-white/90 text-lg">
                        <?php echo e(__('Rejoignez les milliers d\'étudiants qui ont fait confiance à ICORP pour leur préparation. Nos formateurs qualifiés et notre méthode éprouvée vous aideront à atteindre vos objectifs.')); ?>
                ...
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="#formations" class="px-6 py-4 bg-transparent border border-white text-white rounded-md hover:bg-white/10 transition-colors duration-300 text-center font-medium">
                        <?php echo e(__('Voir nos formations')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
                ...
                <p class="text-gray-400 mb-6">
                    <?php echo e(__('ICORP est le leader camerounais de la préparation aux concours et examens avec plus de 15 ans d\'expérience et un taux de réussite exceptionnel.')); ?>
            ...
            <div>
                <h3 class="text-lg font-semibold mb-6"><?php echo e(__('Contact')); ?></h3>
                <ul class="space-y-3">
                    <li class="flex items-start">
        ...
        <div class="border-t border-gray-700 pt-8">
            <div class="flex flex-col md:flex-row md:justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">
                    &copy; <?php echo e(date('Y')); ?> ICORP - Institut de préparation aux concours. <?php echo e(__('Tous droits réservés.')); ?>

                </p>
                <div class="flex space-x-6">
                    <a href="#" class="text-gray-400 hover:text-white text-sm transition-colors duration-300"><?php echo e(__('Politique de confidentialité')); ?></a>
                    <a href="#" class="text-gray-400 hover:text-white text-sm transition-colors duration-300"><?php echo e(__('Mentions légales')); ?></a>
                    <a href="#" class="text-gray-400 hover:text-white text-sm transition-colors duration-300"><?php echo e(__('CGU')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/gabriel/Documents/projects/bussiness/ima-icorp/code-ima-icorp/prod/ima/resources/views/welcome.blade.php ENDPATH**/ ?>