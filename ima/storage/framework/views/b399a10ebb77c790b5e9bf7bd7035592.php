    ...
    <div class="container">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <img src="<?php echo e(asset('logo-icorp-white.png')); ?>" alt="IMA Logo" onerror="this.src='https://via.placeholder.com/200/50'">
            </div>
            <div class="sidebar-menu">
                ...
                <a href="<?php echo e(route('admin.users.index', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.academies.index', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('academies.*', 'departments.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('centers.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('formations.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('transactions.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('payments.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('expenses.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('documents.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('books.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('inventory.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('dashboard', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('contests.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('profile.edit', ['locale' => app()->getLocale()])); ?>" class="menu-item <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
                    <i class="fas fa-user-cog"></i>
                    <span>Mon profil</span>
                </a>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('history.view.own')): ?>
                ...
                <form method="POST" action="<?php echo e(route('logout', ['locale' => app()->getLocale()])); ?>" class="menu-item">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/gabriel/Documents/projects/bussiness/ima-icorp/code-ima-icorp/prod/ima/resources/views/layouts/appv1.blade.php ENDPATH**/ ?>