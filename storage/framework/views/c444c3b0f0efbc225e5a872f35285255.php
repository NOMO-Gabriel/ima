<?php $__env->startSection('title', 'Ajouter une Académie'); ?>
...
<div class="container flex flex-col mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6">
            <form action="<?php echo e(route('admin.academies.store', ['locale' => app()->getLocale()])); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-3 pt-5 border-t border-gray-200">
                    <a href="<?php echo e(route('admin.academies.index', ['locale' => app()->getLocale()])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/jordan/PROJECTS/ima/resources/views/admin/academies/create.blade.php ENDPATH**/ ?>