@if(Session::has('status'))
    <div id="flash-message" class="mb-6 {{ Session::get('status-type') === 'success' ? 'bg-[#34D399]/10 border-[#34D399]' : 'bg-[#F87171]/10 border-[#F87171]' }} text-[#1E293B] rounded-lg p-4 flex items-start">
        ...
        <div>
            <p class="font-medium">{{ Session::get('status-type') === 'success' ? 'Succès!' : 'Information' }}</p>
