...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Ajouter un Cours</h1>
    ...
    <form action="{{ route('admin.courses.store', ['locale' => app()->getLocale()]) }}" method="POST" class="space-y-6 bg-white p-6 rounded-lg shadow">
        @csrf
        ...
        <div>
            <button type="submit"
                class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Ajouter</button>
