...
@section('content')
    ...
    <div class="shadow-md rounded-lg p-6 mb-8 transition-colors duration-300"
        ...
        <!-- Formulaire -->
        <form action="{{ route('admin.rooms.store', ['locale' => app()->getLocale()]) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="relative">
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="ex: Salle 101"
