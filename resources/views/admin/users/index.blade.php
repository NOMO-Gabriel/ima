    ...
    <div class="users-dashboard">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.users.create', ['locale' => app()->getLocale()]) }}" class="btn btn-primary">
        ...
        <div class="stats-container">
            <div class="stats-card">
                ...
                <div class="stats-content">
                    <h3 class="stats-value">{{ $usersCount ?? $users->total() }}</h3>
            ...
            <div class="stats-card">
                ...
                <div class="stats-content">
                    <h3 class="stats-value">{{ $activeUsersCount ?? $users->where('status', 'active')->count() }}</h3>
            ...
            <div class="stats-card">
                ...
                <div class="stats-content">
                    <h3 class="stats-value">{{ $pendingUsersCount ?? $users->whereIn('status', ['pending_validation', 'pending_finalization'])->count() }}</h3>
            ...
            <div class="stats-card">
                ...
                <div class="stats-content">
                    <h3 class="stats-value">{{ $rolesCount ?? $roles->count() }}</h3>
        ...
        <div class="card filter-card">
            ...
            <div class="card-body filter-body">
                <form action="{{ route('admin.users.index', ['locale' => app()->getLocale()]) }}" method="GET" id="filterForm">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('admin.users.index', ['locale' => app()->getLocale()]) }}" class="btn btn-light">
                                    ...
                                    <td>
                                        <div class="user-info">
                                            <div class="user-avatar">
                                                <img src="{{ $user->profile_photo_url }}" alt="{{ $user->first_name }}" class="avatar">
                                    ...
                                    <td>
                                        <div class="role-badges">
                                            @foreach($user->roles as $role)
                                                ...
                                                @endphp
                                                <span class="role-badge {{ $roleColor }}">{{ $role->name }}</span>
                                            @endforeach
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="login-info">
                                            @if($user->last_login_at)
                                                ...
                                                @if($user->last_login_at->diffInDays() < 7)
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('dashboard', ['locale' => app()->getLocale(), 'user' => $user->id]) }}">
                                                    ...
                                                    @if($user->status === 'active')
                                                        <li>
                                                            <form action="{{ route('dashboard', ['locale' => app()->getLocale(), 'user' => $user->id]) }}" method="POST" class="dropdown-form">
                                                                @csrf
                                                    ...
                                                    @if(auth()->id() !== $user->id)
                                                        <li>
                                                            <form action="{{ route('admin.users.destroy', ['locale' => app()->getLocale(), 'user' => $user->id]) }}" method="POST" class="dropdown-form delete-form">
                                                                @csrf
                                                                @method('DELETE')
                            ...
                            <div class="user-card">
                                        ...
                                        <div class="user-card-roles">
                                            @foreach($user->roles as $role)
                                                @php
                                                    ...
                                                    $roleColor = $roleColors[$role->name] ?? 'primary';
                                                @endphp
                                                <span class="role-badge small {{ $roleColor }}">{{ $role->name }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                ...
                                <div class="user-card-body">
                                    ...
                                    <div class="user-card-detail">
                                        ...
                                        <span>
                                        @if($user->last_login_at)
                                                Dernière connexion le {{ $user->last_login_at->format('d/m/Y H:i') }}
                                                @if($user->last_login_at->diffInDays() < 7)
                                ...
                                <div class="user-card-footer">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @elseif($user->status === 'suspended')
                                                <li>
                                                    <form action="{{ route('admin.users.activate', ['locale' => app()->getLocale(), 'user' => $user->id]) }}" method="POST" class="dropdown-form">
                                                        @csrf
                                                        <button type="submit" class="dropdown-item text-success">
                                                            <i class="fas fa-check-circle"></i>Réactiver
                                                        </button>
            ...
            @if($users->hasPages())
                <div class="card-footer">
                    <div class="pagination-info">
                        Affichage de <span>{{ $users->firstItem() ?? 0 }}</span> à <span>{{ $users->lastItem() ?? 0 }}</span> sur <span>{{ $users->total() }}</span> utilisateurs
                    </div>
                    <div class="pagination-controls">
                        <ul class="pagination">
                            ...
                            {{-- Premier et points de suspension --}}
                            @if ($start > 1)
                                <li>
                            ...
                            {{-- Dernier et points de suspension --}}
                            @if ($end < $lastPage)
                                @if ($end < $lastPage - 1)
                                    <li class="dots">
                                        <span>...</span>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (filterForm) {
                filterForm.addEventListener('submit', function(e) {
                    ...
                    if (!hasFilters) {
                        e.preventDefault();
                        window.location.href = "{{ route('admin.users.index', ['locale' => app()->getLocale()]) }}";
                    }
                });
            }
        });
