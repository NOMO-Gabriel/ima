                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ now()->format('d M') }}, 10:00</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ now()->format('d M') }}, 13:30</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Terminé</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap flex gap-2">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ now()->format('d M') }}, 15:00</td>
                            <td class="px-6 py-4 whitespace-nowrap">
