        ...
        <div class="overflow-x-auto rounded-lg border transition-colors duration-150 shadow-sm w-full"
            ...
            <table class="table-fixed" style="min-width: {{ $minTableWidthPx }}px;">
                ...
                <tr class="transition-colors duration-150"
                    :class="darkMode ? 'bg-[#475569]' : 'bg-gray-50'">
                    <th rowspan="2" class="w-24 px-2 py-3 text-center text-xs font-bold uppercase tracking-wider border-r transition-colors duration-150 whitespace-nowrap"
                        :class="darkMode ? 'text-[#F1F5F9] border-[#64748B]' : 'text-white bg-[#4CA3DD] border-gray-200'">
                        Jour
                    </th>
                    <th rowspan="2" class="w-20 px-2 py-3 text-center text-xs font-bold uppercase tracking-wider border-r transition-colors duration-150 whitespace-nowrap"
                        :class="darkMode ? 'text-[#F1F5F9] border-[#64748B]' : 'text-white bg-[#4CA3DD] border-gray-200'">
                        Horaire
                    </th>
...
document.addEventListener('DOMContentLoaded', function() {
    const formationSelect = document.getElementById('formation_id_select');
    const changeFormationForm = document.getElementById('changeFormationForm');

    if (formationSelect && changeFormationForm) {
        formationSelect.addEventListener('change', function() {
            changeFormationForm.submit();
        });
    }
});
</script>
