...
@section('content')
    ...
    <div class="shadow-md rounded-lg p-6 mb-8 transition-colors duration-300"
        ...
        <!-- Formulaire -->
        <form action="{{ route('admin.books.store', ['locale' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="ex: Mathématiques Terminale C"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="author" id="author" value="{{ old('author') }}" placeholder="ex: Jean Dupont"
                               class="block w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-[#4CA3DD] focus:border-[#4CA3DD] sm:text-sm transition-colors duration-300"
                               :class="{ 'bg-gray-700 border-gray-600 text-white': darkMode, 'bg-white border-gray-300 text-gray-700': !darkMode }" />
                        @error('author')
                        <p class="mt-2 text-sm transition-colors duration-300"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="publisher" id="publisher" value="{{ old('publisher') }}" placeholder="ex: Éditions Hachette"
                               class="block w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-[#4CA3DD] focus:border-[#4CA3DD] sm:text-sm transition-colors duration-300"
                               :class="{ 'bg-gray-700 border-gray-600 text-white': darkMode, 'bg-white border-gray-300 text-gray-700': !darkMode }" />
                        @error('publisher')
                        <p class="mt-2 text-sm transition-colors duration-300"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="publicationYear" id="publicationYear" value="{{ old('publicationYear', date('Y')) }}" min="1900" max="{{ date('Y') + 1 }}"
                                   class="block w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-[#4CA3DD] focus:border-[#4CA3DD] sm:text-sm transition-colors duration-300"
                                   :class="{ 'bg-gray-700 border-gray-600 text-white': darkMode, 'bg-white border-gray-300 text-gray-700': !darkMode }" />
                        ...
                        <div class="form-group">
                            <label for="isbn" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#4CA3DD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <input type="text" name="isbn" id="isbn" value="{{ old('isbn') }}" placeholder="978-2-123456-78-9"
                                   class="block w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-[#4CA3DD] focus:border-[#4CA3DD] sm:text-sm transition-colors duration-300"
                                   :class="{ 'bg-gray-700 border-gray-600 text-white': darkMode, 'bg-white border-gray-300 text-gray-700': !darkMode }" />
                            @error('isbn')
                            <p class="mt-2 text-sm transition-colors duration-300"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group">
                            <label for="category" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#4CA3DD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="form-group">
                            <label for="lang" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#4CA3DD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Colonne droite -->
                <div class="space-y-6">
                    <!-- Nombre de pages et Quantité -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group">
                            <label for="nb_pages" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#4CA3DD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <input type="number" name="nb_pages" id="nb_pages" value="{{ old('nb_pages') }}" min="1"
                                   class="block w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-[#4CA3DD] focus:border-[#4CA3DD] sm:text-sm transition-colors duration-300"
                                   :class="{ 'bg-gray-700 border-gray-600 text-white': darkMode, 'bg-white border-gray-300 text-gray-700': !darkMode }" />
                            @error('nb_pages')
                            <p class="mt-2 text-sm transition-colors duration-300"
                        ...
                        <div class="form-group">
                            <label for="quantity" class="block text-sm font-medium mb-2 transition-colors duration-300"
                                   :class="{ 'text-gray-300': darkMode, 'text-gray-700': !darkMode }">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#4CA3DD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" rows="4" placeholder="Description du livre, résumé, table des matières..."
                          class="block w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-[#4CA3DD] focus:border-[#4CA3DD] sm:text-sm transition-colors duration-300"
                          :class="{ 'bg-gray-700 border-gray-600 text-white': darkMode, 'bg-white border-gray-300 text-gray-700': !darkMode }">{{ old('description') }}</textarea>
                @error('description')
                <p class="mt-2 text-sm transition-colors duration-300"
                   :class="{ 'text-red-400': darkMode, 'text-red-600': !darkMode }">
                    {{ $message }}
