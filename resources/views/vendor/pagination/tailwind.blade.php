                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-[#4CA3DD] border border-[#4CA3DD] cursor-default leading-5 select-none">{{ $page }}</span>
                                    </span>
                                @else
