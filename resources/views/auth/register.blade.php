            ...
            <form class="space-y-6" method="POST" action="{{ route('register') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="form-input mt-1">
                            ...
                            <x-text-input id="first_name" class="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                    ...
                    <div>
                        ...
                        <div class="form-input mt-1">
                            <i class="fas fa-user"></i>
                            <x-text-input id="last_name" class="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="form-input mt-1">
                            ...
                            <x-text-input id="email" class="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                    ...
                    <div>
                        ...
                        <div class="form-input mt-1">
                            ...
                            <x-text-input id="phone_number" class="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                    ...
                    <div>
                        ...
                        <div class="form-input mt-1">
                            ...
                            <x-text-input id="city" class="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="form-input mt-1">
                            <i class="fas fa-lock"></i>
                            <x-text-input id="password_confirmation" class="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                      type="password"
