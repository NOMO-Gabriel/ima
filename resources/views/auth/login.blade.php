        ...
        <div class="w-full lg:w-1/2 bg-[#F8FAFC] flex items-center justify-center p-6">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-[#1E293B]">{{ __('Connexion') }}</h2>
                    <p class="text-[#64748B] mt-2">Accédez à votre espace personnel</p>
                </div>

                <form class="space-y-5" method="POST" action="{{ route('login', ['locale' => app()->getLocale()]) }}" id="loginForm">
                    @csrf
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            <x-input-label for="password" :value="__('Mot de passe')" class="block text-sm font-medium text-[#1E293B]" />
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request', ['locale' => app()->getLocale()]) }}" class="text-sm font-medium text-[#2A7AB8] hover:text-[#4CA3DD] hover:underline transition duration-150 ease-in-out">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-[#64748B]">
                            ...
                            <a href="{{ route('register', ['locale' => app()->getLocale()]) }}" class="font-medium text-[#2A7AB8] hover:underline">
